...
cube_rollup_list : ( CUBE^ LEFT_PAREN! real_arg ( COMMA! real_arg )* RIGHT_PAREN! ) | ( ROLLUP^ LEFT_PAREN! real_arg ( COMMA! real_arg )* RIGHT_PAREN! ( pivot_clause | ( chunksize_clause rate_clause ) )? )
;

h2irg_clause
    : pivot_clause | autopivot_clause 
;
...
autopivot_clause
    : chunksize_clause rate_clause
;

chunksize_clause: CHUNKSIZE^ INTEGER
;

rate_clause: RATE^ DOUBLENUMBER
;
