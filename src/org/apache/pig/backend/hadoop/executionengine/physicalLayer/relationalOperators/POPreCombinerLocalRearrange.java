...
public class POPreCombinerLocalRearrange extends PhysicalOperator {
    ...
    public static long prePreCombiner = 0;
    
    public static long PreCombiner = 0;
    ...
    public Result getNextTuple() throws ExecException {
        ...
        while (true) {
            ...
            prePreCombiner = System.currentTimeMillis();
            inp = processInput();
            PreCombiner += System.currentTimeMillis() - prePreCombiner;
            ...
            for (ExpressionOperator op : leafOps){
                ...
                case DataType.TUPLE:
                    //prePreCombiner = System.currentTimeMillis();
                    //System.out.println("PreCombiner start: " + prePreCombiner);
                    res = op.getNext(op.getResultType());
                    //System.out.println("PreCombiner end: " + System.currentTimeMillis());
                    //PreCombiner += System.currentTimeMillis() - prePreCombiner;
                    break;
                default:
