...
public class PlanHelper {
    ...
    private static class OpFinder<C extends PhysicalOperator> extends PhyPlanVisitor {
        ...
        @Override
        public void visitPORollupH2IRGForEach(PORollupH2IRGForEach hfe) throws VisitorException {
            super.visitPORollupH2IRGForEach(hfe);
            visit(hfe);
        }
        ...
        public void visitUserFuncRollupSample(POUserFuncRollupSample userFunc) throws VisitorException {
            super.visitUserFuncRollupSample(userFunc);
            visit(userFunc);
        }
