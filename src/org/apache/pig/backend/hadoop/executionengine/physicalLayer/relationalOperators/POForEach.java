...
public class POForEach extends PhysicalOperator {
    ...
    private static final String ALGEBRAIC_UDF = "org.apache.pig.builtin.AlgebraicMathBase$Initial";
    
    public static long preForEachCombiner = 0;
    
    public static long preForEachRollup = 0;
    
    public static long preForEachLoadCast = 0;
    
    public static long forEachCombinerTime = 0;
    
    public static long forEachRollupTime = 0;
    
    public static long forEachLoadCast = 0;
