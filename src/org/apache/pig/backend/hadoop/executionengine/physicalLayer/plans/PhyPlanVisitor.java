...
public class PhyPlanVisitor extends PlanVisitor<PhysicalOperator,PhysicalPlan> {
    ...
    public void visitRollupCombinerPackage(PORollupCombinerPackage pkg) throws VisitorException{
        //do nothing
    }
    ...
    public void visitPORollupSampling(PORollupSampling nfe) throws VisitorException {
        visitPOForEach(nfe);
    }
    ...
    public void visitUserFuncRollupSample(POUserFuncRollupSample userFunc) throws VisitorException {
        //do nothing
    }
