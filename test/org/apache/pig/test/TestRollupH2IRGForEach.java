 ...
 *
 */
public class TestRollupH2IRGForEach {
    PORollupH2IRGForEach rfe;
    Tuple t;
    DataBag db;
    DataBag projDB;
    ...
    public void setUp() throws Exception {
        ...
        rfe = GenPhyOp.topRollupH2IRGForEachOPWithPlan(0, db.iterator().next());
    ...
    public void testGetNextTuple() throws ExecException, IOException {
        int size = 0;
        for (Result res = rfe.getNextTuple(); res.returnStatus != POStatus.STATUS_EOP; res = rfe
                .getNextTuple()) {
