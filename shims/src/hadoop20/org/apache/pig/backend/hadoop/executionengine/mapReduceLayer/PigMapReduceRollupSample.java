...
public class PigMapReduceRollupSample extends PigGenericMapReduce {
    public static class ReduceRollupSample extends PigGenericMapReduce.Reduce {
        ...
        public boolean inIllustrator(
            ...
            return (context instanceof PigMapReduceRollupSample.ReduceRollupSample.IllustratorContext);
        }

        @Override
        public POPackage getPack(
                org.apache.hadoop.mapreduce.Reducer.Context context) {
            return ((PigMapReduceRollupSample.ReduceRollupSample.IllustratorContext) context).pack;
        }
    }
}
