...
public class PigMapReduceRollupSample extends PigGenericMapReduce {
    ...
    static class IllustrateReducerContext extends WrappedReducer<PigNullableWritable, NullableTuple, PigNullableWritable, Writable> {
        ...
        public class IllustratorContext 
            ...
            public POPackage getPack() {
                return ((ReduceRollupSample.IllustratorContextImpl)reduceContext).pack;
            }
        }
    }
          
    public static class ReduceRollupSample extends PigGenericMapReduce.Reduce {
        /**
        ...
        public boolean inIllustrator(org.apache.hadoop.mapreduce.Reducer.Context context) {
            return (context instanceof PigMapReduceRollupSample.IllustrateReducerContext.IllustratorContext );
        }

        @Override
        public POPackage getPack(org.apache.hadoop.mapreduce.Reducer.Context context) {
            return ((PigMapReduceRollupSample.IllustrateReducerContext.IllustratorContext) context).getPack();
        }
    }
}
